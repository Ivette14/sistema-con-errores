        <div class="row">
          <div class="col-lg-12">
            ...
            <!-- /.row -->
        <div class="form-group"> <button type="button" onclick=location="<?php echo base_url().'crud_activo/index_nuevo'; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>&nbsp;Nuevo</button></div>       
            <div class="row">
                <div class="col-lg-12">
